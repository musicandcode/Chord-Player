import { IntervalName, Named, NoteName } from "@tonaljs/tonal";
/**
 ...
 */
export declare function pcset(src: Set): Pcset;
/**
 * @private
 ...
 */
export declare function isSubsetOf(set: Set): (notes: string | number | Pcset | string[] | Partial<Pcset>) => boolean | 0;
/**
 * Create a function that test if a collection of notes is a
 ...
 */
export declare function isNoteIncludedInSet(set: Set): (noteName: string) => boolean;
/** @deprecated use: isNoteIncludedIn */
export declare const includes: typeof isNoteIncludedInSet;
/**
