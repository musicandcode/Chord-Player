 ...
 */
export declare function numeric(notes: Array<string | number>): number[];
/**
 ...
 */
export declare function chromatic(notes: Array<string | number>, options?: ToNoteNameOptions): string[];
